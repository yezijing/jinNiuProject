        ...
        <el-col :span="12">
          <fieldset>
            ...
            <div class="boxcontent editplanwrap">
              <el-form label-width="120px" size="medium" ref="basicInfo" :model="basicInfo">
                <div class="addbox">
                  <el-form-item
                    label="年度："
                    prop="yearid"
                ...
                <div class="addbox">
                  ...
                  <div class="jiabtn">
                    ...
                    <div class="awrap" v-if="bitemShow">
                      <p>新增大项</p>
                      <el-input placeholder="请输入大项名称" v-model="bitemname"></el-input>
                      <div class="buttons">
    ...
    submitAll: function() {
      this.$refs.basicInfo.validate(valid => {
        if (valid) {
          ...
          editThreePlan(para, res => {
            let cpara = { workid: this.workid, typemodel: this.typemodel };
            changeCheckFormstate(cpara, data => {
              synchFormstate(
                { workid: this.workid, typemodel: this.typemodel },
                ress => {
                  this.$emit("my-event");
                  this.$emit("add-event");
                  this.$message({
