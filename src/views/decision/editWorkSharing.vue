...
import { editThreePlan, editThreePlan2 } from "../../api/workApi";
export default {
  props: [
    "leaderlist",
    "deptlist",
    ...
    submitAll: function() {
      this.$refs.basicInfo.validate(valid => {
        if (valid) {
          ...
          if (this.typemodel == 1) {
            let para = { decisionUp: this.basicInfo };
            ...
            para.decisionUp.id = this.workid;
            ...
            let opara = { decisionIArea: this.basicInfo };
            ...
            opara.decisionIArea.id = this.workid;
            opara = JSON.stringify(opara);
            editThreePlan2(opara, res => {
              this.$message({
                message: "编辑成功",
                type: "success"
              });
