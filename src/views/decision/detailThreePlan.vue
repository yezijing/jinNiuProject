          ...
          <el-col :span="12">
            <fieldset>
              ...
              <div class="boxcontent">
                <el-form ref="basicInfo" size="small" :model="basicInfo" label-width="120px">
                  <el-form-item label="年度：" prop="yearname">
                    <el-input v-model="basicInfo.yearname" readonly></el-input>
                  </el-form-item>
                  <el-form-item :label="typemodel==1?'一级工作：':'工作要求：'" prop="bigname">
                    <el-input v-model="basicInfo.bigname" readonly></el-input>
                  </el-form-item>
                  <el-form-item label="二级工作：" prop="minname">
                    <el-input v-model="basicInfo.minname" readonly></el-input>
                  </el-form-item>
...
<script>
import { reportPlanHistory } from "../../api/decisionApi";
...
export default {
  ...
  methods: {
    ...
    // 进展汇报
    lookProgress() {
      let para = { workid: this.workid, typemodel: this.typemodel };
