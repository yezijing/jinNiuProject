              ...
              <div class="boxcontent">
                <el-form ref="basicInfo" size="small" :model="basicInfo" label-width="120px">
                  ...
                  <el-form-item label="任务名称：" prop="workname">
                    <el-input v-model="basicInfo.workname" readonly></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="督查单位：" prop="secondwork">
                    <el-input readonly v-model="basicInfo.secondwork"></el-input>
                  </el-form-item>
                </el-form>
              </div>
            </fieldset>
              ...
              <div class="boxcontent">
                ...
                <div class="speed">
                  <div class="pbox">
                    <p class="tt">上次进展情况：</p>
                    <div class="conbox">
                      <!-- <p v-for="(citem, index) in lastprogress" :key="index">{{citem.question}}</p> -->
                      <p>{{lastprogress}}</p>
                    </div>
                  </div>
                  <div class="pbox">
...
<script>
import { historyKeywork } from "../../api/threework";
