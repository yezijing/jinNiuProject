          ...
          <el-col :span="12">
            <fieldset>
              ...
              <div class="boxcontent">
                <el-form ref="basicInfo" size="small" :model="basicInfo" label-width="110px">
                  ...
                  <el-form-item label="具体片区：" prop="nodeplan">
                    <el-input v-model="basicInfo.nodeplan" readonly></el-input>
                  </el-form-item>
                  <el-form-item label="项目名称：" prop="workname">
                    <el-input readonly v-model="basicInfo.workname"></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="督查单位：" prop="superdept">
                    <el-input readonly v-model="basicInfo.superdept"></el-input>
                  </el-form-item>
                </el-form>
              </div>
            </fieldset>
                  ...
                  <el-table-column prop="status" label="状态">
                    <template slot-scope="scope">
                      <div>
                        ...
                        <el-tag size="medium" type="info" v-if="scope.row.status==2">
                          <i class="fa mark"></i>
                          <span>未执行</span>
                        </el-tag>
                        <el-tag size="medium" type="danger" v-if="scope.row.status==0">
...
<script>
import { historyKeyArea } from "../../api/threework";
export default {
  props: [
    "ddheight",
    "leadsData",
