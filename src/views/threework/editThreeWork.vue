        ...
        <el-col :span="12">
          <fieldset>
            ...
            <div class="boxcontent editplanwrap">
              <el-form label-width="100px" size="medium" ref="basicInfo" :model="basicInfo">
                <div class="addbox">
                  <el-form-item
                    label="年度："
                    prop="yearid"
...
import { editKeyItem,changeKeyitemFormstate,synchKeyitemFormstate } from "../../api/threework";
export default {
  props: [
    "leaderlist",
    "deptlist",
      ...
      this.$refs.basicInfo.validate(valid => {
        if (valid) {
          ...
          editKeyItem(para, res => {
            ...
            // this.$emit("my-event");
            // this.$emit("add-event");
            changeKeyitemFormstate({ eid: this.workid }, data => {
              synchKeyitemFormstate({ eid: this.workid }, ress => {
                this.$emit("my-event");
                this.$emit("add-event");
                this.$message({
                  message: "编辑成功",
