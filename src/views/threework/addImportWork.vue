          ...
          <fieldset>
            ...
            <div class="boxcontent boxcontent0">
              <el-form label-width="120px" size="small" ref="basicInfo" :model="basicInfo">
                ...
                <div class="addbox">
                  <el-form-item label="具体任务：" prop="minid">
                    <el-select
...
import {
  ...
  addImportFirstTerm,
  importWorkFirstList,
  addImportWorkMinterm,
  importWorkBigMinList,
  addSeer,
  seerList,
  threeworkList,
  addThreework,
  changeCheckFormstateImportwork,
  synchFormstateImportwork,
  getAllPlanlist,
  checkReportRules
} from "../../api/decisionApi";
export default {
  props: ["leaderlist", "deptlist", "addheight","yearid"],
  components: {},
  data() {
    return {
      checkAll: false,
  ...
  methods: {
    ...
    getbigterm() {
      if (this.basicInfo.yearid == null) {
        ...
        let para = { yearid: this.basicInfo.yearid };
        importWorkFirstList(para, data => {
    ...
    getBiglist() {
      if (this.basicInfo.yearid == null || this.basicInfo.bigid == null) {
        ...
        importWorkBigMinList(para, data => {
    ...
    addSubterm() {
      if (this.basicInfo.yearid == null || this.basicInfo.bigid == null) {
        ...
        addImportWorkMinterm(para, data => {
      ...
      this.$refs.basicInfo.validate(valid => {
        if (valid) {
          if (this.leadsData == []) {
            ...
            addImportWorkData(para, res => {
              if (res.data.code == "0") {
                let cpara = { pointid: res.data.obj};
                changeCheckFormstateImportwork(cpara, data => {
                  synchFormstateImportwork(
                    { pointid: res.data.obj },
                    ress => {
                      this.$emit("my-event");
                      this.$emit("add-event");
                      this.$message({
